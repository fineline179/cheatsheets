...
\usepackage{amsthm} % more advanced theorem environments
...
\newcommand{\E}{\mathbb{E}} % (statistical) expectation
\newcommand{\cO}{\mathcal{O}} % abbreviation for script "O", (for 'order')
\newcommand{\cN}{\mathcal{N}} % abbreviation for script "N", (eg Normal distribution)
\newcommand{\lp}{\left(}
\newcommand{\rp}{\right)}
\newcommand{\lb}{\left[}
\newcommand{\rb}{\right]}
...
\newcommand{\LATODO}[1]{\red{$\leftarrow$ \tbf{TODO: #1}}} % TODO preceded by left arrow 
...
%% Proclamation styles with manual numbering
