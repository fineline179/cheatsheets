...
\paragraph{One-versus-all:} For $k$ classes, do $k$ normal log regs. Each has two
...
\subsection{GDA}
Can used GDA for classification problem when input features are continuous-val random
