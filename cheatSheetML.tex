...
%% GITHUB SSH ACCESS IN EMACS TEST 1
%% GITHUB SSH ACCESS IN EMACS TEST 2
...
dataset. The \tbfit{principal components} are a set of $n$ orthonormal
...
\begin{itemize}
  \item \tbf{Reduce bias (tr set perf):} Bigger network, train longer, (NN arch
  search)
